...
@section('content')
    ...
    <div class="main-panel">
        <div class="content admin-appearance-page">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <!-- Preview Card -->
                                <div class="card mb-4 text-white appearance-preview-card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-4">
                                            <div>
                                                <span class="preview-icon"><i class="ri-palette-line"></i></span>
                                            </div>
                                            <div>
                            ...
                            <div class="card-body">
                                @if($appearanceSettings->custom_css)
                                    <div class="alert alert-info">
                                        <h5><i class="ri-information-line mr-2"></i> Custom CSS Enabled</h5>
                                ...
                                @else
                                    <div class="alert alert-secondary">
                                        <h5><i class="ri-information-line mr-2"></i> No Custom CSS</h5>
                                            ...
                                            <div class="card bg-light mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><i class="ri-font-size"></i></span>
                                                            </div>
                                            ...
                                            <div class="card bg-light mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><i class="ri-side-bar-line"></i></span>
                                                            </div>
