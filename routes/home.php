...
Route::get('cards', [HomePageController::class, 'cards'])->name('public.cards');
Route::get('personal', [HomePageController::class, 'personal'])->name('personal');
Route::get('chart', [HomePageController::class, 'personal'])->name('chart');
...
Route::get('terms-of-service', [HomePageController::class, 'terms'])->name('terms-of-service');
Route::get('alerts', [HomePageController::class, 'business'])->name('alerts');
